...
struct updateAddressView: View {
    ...
    @State private var showReportAddressModal = false
    ...
    var body: some View {
        NavigationView {
            ...
            .padding(.top)
            .overlay(
                showReportAddressModal ?
                SheetView(isPresented: $showReportAddressModal) {
                    ReportPhoneNumberBottomSheet(isPresented: $showReportAddressModal)
                } : nil
            )
        }
    }
